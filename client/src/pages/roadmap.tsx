          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="text-center mb-16 max-w-4xl mx-auto">
              <h2 className="text-xl md:text-2xl font-medium text-foreground font-sans mb-8">
                <span className="text-brand-700">Pour the foundation, build the structure, and seal the cracks.</span>
              </h2>
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="text-center mb-8">
                  <div className="text-brand-600 font-bold mb-2 uppercase tracking-wider text-sm">Block 1</div>
                ...
                <div className="space-y-4">
                  <div className="bg-brand-50/50 p-6 md:p-8 rounded-3xl border border-brand-100/50 text-center">
                    <div className="inline-flex text-brand-600 mb-4 shrink-0 bg-white p-3 rounded-2xl shadow-sm"><BookOpen size={28}/></div>
                    <div>
                      <div className="font-mono text-sm text-brand-600 mb-2 font-bold tracking-wider">HOUR 1</div>
              ...
              <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="text-center mb-8">
                  <div className="text-brand-600 font-bold mb-2 uppercase tracking-wider text-sm">Block 2</div>
                ...
                <div className="space-y-6">
                  <div className="bg-brand-50/50 p-6 md:p-8 rounded-3xl border border-brand-100/50 text-center">
                    <div className="inline-flex text-brand-600 mb-4 shrink-0 bg-white p-3 rounded-2xl shadow-sm"><Zap size={28}/></div>
                    <div>
                      <div className="font-mono text-sm text-brand-600 mb-2 font-bold tracking-wider">HOURS 2 & 3</div>
                      ...
                      <img src={ppgrImage} alt="PPGR Movements: Principle, Problem, Gospel, Response" className="w-full max-w-lg mx-auto h-auto rounded-xl border-none mix-blend-multiply" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="text-center mb-8">
                  <div className="text-brand-600 font-bold mb-2 uppercase tracking-wider text-sm">Block 3</div>
                ...
                <div className="space-y-4">
                  <div className="bg-brand-50/50 p-6 md:p-8 rounded-3xl border border-brand-100/50 text-center">
                    <div className="inline-flex text-brand-600 mb-4 shrink-0 bg-white p-3 rounded-2xl shadow-sm"><ShieldCheck size={28}/></div>
                    <div>
                      <div className="font-mono text-sm text-brand-600 mb-2 font-bold tracking-wider">HOUR 4</div>
