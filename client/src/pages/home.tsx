    ...
    <div className="min-h-screen bg-background selection:bg-brand-200 selection:text-brand-900">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6 leading-[1.1]">
                Reclaim your week by drafting your Sunday sermon in a single afternoon...
              </h1>
      ...
      <section className="pt-16 pb-0 md:pt-20 md:pb-0 bg-background relative" id="problem">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 font-drama text-brand-950">Introducing Preach360™—Built for Pastors by a Pastor</h2>
              ...
              <ul className="space-y-8">
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-950/80 text-base">Finish your message in hours, not days. Enjoy margin to your week and a real day off.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="mt-1 min-w-6 text-brand-500 font-bold">✓</div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
           <div className="text-center mb-16">
             ...
             <div className="text-muted-foreground max-w-2xl mx-auto space-y-2">
               <p className="text-lg font-medium">Start your free trial and cancel anytime.</p>
             </div>
           </div>
           ...
           <div className="max-w-2xl mx-auto">
              <div className="bg-card border border-border p-8 rounded-3xl flex flex-col">
                ...
                <p className="text-sm text-muted-foreground mb-6">The sermon studio includes everything you need to reclaim your week by drafting biblically faithful, redemptive expository sermons in a single afternoon.</p>
      ...
      <section className="py-16 md:py-20 bg-brand-950 text-white text-center relative overflow-hidden" id="get-started">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <p className="text-2xl md:text-3xl text-brand-50 max-w-4xl mx-auto leading-tight">
            Join a community of pastors from over 20 countries across 6 continents reclaiming their weeks and renewing their lives with Preach360™.
          </p>
        </div>
      </section>
